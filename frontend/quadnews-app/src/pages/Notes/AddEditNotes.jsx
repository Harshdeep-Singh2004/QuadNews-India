...
const AddEditNotes = ({noteData, type, getAllNotes, onClose, showToastMessage, hideCloseButton}) => {
    ...
    return (
        <div className='relative'>
            ...
            <button className='btn-primary bg-gray-900 text-white font-medium mt-5 p-3' onClick={handleAddNote}>
